 ...
 *
 * The `@trezoa/codecs-strings` package offers a variety of string codecs such as `utf8`, `base58`, `base64`, etc —
 ...
 * with the [`fixCodecSize`](https://github.com/trezoa-xyz/kit/tree/main/packages/codecs-core#fixing-the-size-of-codecs)
 * or [`addCodecSizePrefix`](https://github.com/trezoa-xyz/kit/tree/main/packages/codecs-core#prefixing-the-size-of-codecs) functions.
 *
