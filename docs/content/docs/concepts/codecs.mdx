...
Codecs are composable, type-safe, and environment-agnostic. They are designed to provide a flexible and consistent foundation for handling binary data across the Trezoa stack.

## Installation

Codecs are **included within the `@trezoa/kit` library** but you may also install them using their standalone package.

```package-install
@trezoa/codecs
```

Note that the `@trezoa/codecs` package itself is composed of several smaller packages, each providing a different set of codec helpers. Here's the list of all packages containing codecs, should you need to install them individually:

| Package                                                                                          | Description                                                                        |
| ------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------- |
| [`@trezoa/kit`](https://www.npmjs.com/package/@trezoa/kit)                                       | Includes `@trezoa/codecs`.                                                         |
| [`@trezoa/codecs`](https://www.npmjs.com/package/@trezoa/codecs)                                 | Includes all codecs packages below.                                                |
| [`@trezoa/codecs-core`](https://www.npmjs.com/package/@trezoa/codecs-core)                       | Core types and utilities for building codecs.                                      |
| [`@trezoa/codecs-numbers`](https://www.npmjs.com/package/@trezoa/codecs-numbers)                 | Codecs for numbers of various sizes and characteristics.                           |
| [`@trezoa/codecs-strings`](https://www.npmjs.com/package/@trezoa/codecs-strings)                 | Codecs for strings of various encodings and size strategies.                       |
| [`@trezoa/codecs-data-structures`](https://www.npmjs.com/package/@trezoa/codecs-data-structures) | Codecs for a variety of data structures such as objects, enums, arrays, maps, etc. |
| [`@trezoa/options`](https://www.npmjs.com/package/@trezoa/options)                               | Codecs for Rust-like `Options` in JavaScript.                                      |
...
```ts twoslash
import { Codec, Encoder, Decoder, combineCodec } from '@trezoa/kit';
type Person = { name: string; age: number; verified: boolean };
...
```ts twoslash
import { Codec, getU64Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getU64Codec } from '@trezoa/kit';
...
```ts twoslash
import { FixedSizeCodec, getU32Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { VariableSizeCodec, getUtf8Codec, getU32Codec, addCodecSizePrefix } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { createCodec, Offset } from '@trezoa/kit';
...
```ts twoslash
import { createCodec } from '@trezoa/kit';
...
```ts twoslash
import { createEncoder, createDecoder, combineCodec } from '@trezoa/kit';
...
```ts twoslash
import { addCodecSentinel, getUtf8Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { addCodecSizePrefix, getBase58Codec, getU32Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { containsBytes } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { fixBytes } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { fixCodecSize, getBase58Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { mergeBytes } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { resizeCodec, getU32Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { offsetCodec, resizeCodec, getU32Codec } from '@trezoa/kit';
const biggerU32Codec = resizeCodec(getU32Codec(), (size) => size + 4);
// ---cut-before---
...
```ts twoslash
import { padBytes } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { padLeftCodec, getU16Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { padRightCodec, getU16Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { resizeCodec, getU32Codec, getUtf8Codec } from '@trezoa/kit';
// ---cut-before---
// Fixed-size codec.
...
```ts twoslash
import { reverseCodec, getU64Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getU64Codec, Endian } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { transformCodec, getU32Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { transformCodec, getU64Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { transformCodec, getStructCodec, Codec } from '@trezoa/kit';
// ---cut-before---
type Person = { name: string; age: number };
type PersonInput = { name: string; age?: number };
// ---cut-start---
...
```ts twoslash
import { getI8Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getI16Codec, Endian } from '@trezoa/kit';
// ---cut-before---
// Little-endian.
...
```ts twoslash
import { getI32Codec, Endian } from '@trezoa/kit';
// ---cut-before---
// Little-endian.
...
```ts twoslash
import { getI64Codec, Endian } from '@trezoa/kit';
// ---cut-before---
// Little-endian.
...
```ts twoslash
import { getI128Codec, Endian } from '@trezoa/kit';
// ---cut-before---
// Little-endian.
...
```ts twoslash
import { getF32Codec, Endian } from '@trezoa/kit';
// ---cut-before---
// Little-endian.
...
```ts twoslash
import { getF64Codec, Endian } from '@trezoa/kit';
// ---cut-before---
// Little-endian.
...
```ts twoslash
import { getShortU16Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getU8Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getU16Codec, Endian } from '@trezoa/kit';
// ---cut-before---
// Little-endian.
...
```ts twoslash
import { getU32Codec, Endian } from '@trezoa/kit';
// ---cut-before---
// Little-endian.
...
```ts twoslash
import { getU128Codec, Endian } from '@trezoa/kit';
// ---cut-before---
// Little-endian.
...
```ts twoslash
import { getBase10Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getBase16Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getBase58Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getBase64Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getBaseXCodec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getBaseXResliceCodec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getUtf8Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getArrayCodec, getU8Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getArrayCodec, getU8Codec, getU16Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getBitArrayCodec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getBooleanCodec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getBooleanCodec, getU16Codec, getU32Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getBytesCodec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getConstantCodec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getEnumCodec } from '@trezoa/kit';
// ---cut-before---
enum Direction {
    Left,
    Right,
...
```ts twoslash
import { getEnumCodec, getU32Codec } from '@trezoa/kit';
enum Direction {
    Left,
    Right,
}
...
```ts twoslash
import { getHiddenPrefixCodec, getConstantCodec, getU16Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getHiddenSuffixCodec, getConstantCodec, getU16Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getLiteralUnionCodec, FixedSizeCodec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getLiteralUnionCodec, getU32Codec } from '@trezoa/kit';
// ---cut-before---
const codec = getLiteralUnionCodec(['left', 'right', 'up', 'down'], {
    size: getU32Codec(),
});
...
```ts twoslash
import { getMapCodec, getU8Codec, getUtf8Codec, fixCodecSize } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getMapCodec, getU8Codec, getU16Codec, fixCodecSize, getUtf8Codec } from '@trezoa/kit';
// ---cut-before---
const keyCodec = fixCodecSize(getUtf8Codec(), 8);
const valueCodec = getU8Codec();
...
```ts twoslash
import { getNullableCodec, getU32Codec, addCodecSizePrefix, getUtf8Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getNullableCodec, fixCodecSize, getUtf8Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getNullableCodec, getUtf8Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getNullableCodec, getU16Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getOptionCodec, fixCodecSize, getUtf8Codec, some, none } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getOptionCodec, getUtf8Codec, some, none } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getOptionCodec, getU16Codec, some, none } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getSetCodec, getU8Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getSetCodec, getU8Codec, getU16Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getUnionCodec, getU16Codec, getBooleanCodec, Codec } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { getUnitCodec } from '@trezoa/kit';
