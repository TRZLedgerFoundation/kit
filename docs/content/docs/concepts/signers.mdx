...
Signers are **included within the `@trezoa/kit` library** but you may also install them using their standalone package.
...
```ts twoslash
// @noErrors: 2355
import { address, SignatureDictionary, Transaction, TransactionPartialSigner } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
// @noErrors: 2355
import { address, SignatureBytes, Transaction, TransactionSendingSigner } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { SignatureDictionary } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
import { address, createSignableMessage, SignatureBytes } from '@trezoa/kit';
// ---cut-before--
...
```ts twoslash
// @noErrors: 2355
import { address, MessagePartialSigner, SignableMessage, SignatureDictionary } from '@trezoa/kit';
// ---cut-before---
...
```ts twoslash
// @noErrors: 2355
import { address, MessageModifyingSigner, SignableMessage } from '@trezoa/kit';
// ---cut-before---
...
const myTransaction = null as unknown as Transaction &
    ...
    TransactionWithLifetime;
// ---cut-before---
import { createNoopSigner } from '@trezoa/kit';
...
```ts twoslash
import { createSignerFromKeyPair, generateKeyPair, KeyPairSigner } from '@trezoa/kit';
...
```ts twoslash
import fs from 'fs';
import { createKeyPairSignerFromBytes } from '@trezoa/kit';
...
```ts twoslash
import { createKeyPairSignerFromPrivateKeyBytes, getUtf8Encoder } from '@trezoa/kit';
