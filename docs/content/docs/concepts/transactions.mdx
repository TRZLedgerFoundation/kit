...
To take an action on Trezoa, whether to place an order, transfer an asset, or more generally to modify data on the blockchain, you need to prepare a transaction and sign to pay for it to be executed on the network. You can use Kit to create, sign, encode, and decode transactions.

## Installation

Transaction utilities are **included within the `@trezoa/kit` library** but you may also install them using their standalone packages.
...
A Transaction is a vehicle to deliver one or more instructions to the Trezoa network in pursuit of some outcome.
...
```ts twoslash
import { Blockhash, TransactionSigner } from '@trezoa/kit';
...
const transactionMessage = pipe(
    ...
    // NOTE: This is not the fee for the coffee but rather the fee to use the Trezoa network.
...
```ts twoslash
import { createTransactionMessage } from '@trezoa/kit';
...
```ts twoslash
import { TransactionMessage } from '@trezoa/kit';
const keyPair = null as unknown as CryptoKeyPair;
const transactionMessage = null as unknown as TransactionMessage;
// ---cut-before---
import { createSignerFromKeyPair, setTransactionMessageFeePayerSigner } from '@trezoa/kit';
...
const transactionMessage = null as unknown as TransactionMessage;
// ---cut-before---
import { address, setTransactionMessageFeePayer } from '@trezoa/kit';
...
```ts twoslash
import { Rpc, GetLatestBlockhashApi, TransactionMessage } from '@trezoa/kit';
const rpc = null as unknown as Rpc<GetLatestBlockhashApi>;
const transactionMessage = null as unknown as TransactionMessage;
// ---cut-before---
import { setTransactionMessageLifetimeUsingBlockhash } from '@trezoa/kit';
...
```ts twoslash
import { TransactionMessage, address, Rpc, GetAccountInfoApi } from '@trezoa/kit';
const rpc = null as unknown as Rpc<GetAccountInfoApi>;
const transactionMessage = null as unknown as TransactionMessage;
// ---cut-before---
import { Nonce, setTransactionMessageLifetimeUsingDurableNonce } from '@trezoa/kit';
...
```ts twoslash
import { TransactionMessageWithDurableNonceLifetime } from '@trezoa/kit';
...
const transactionMessage = null as unknown as TransactionMessage;
// ---cut-before---
import { address, appendTransactionMessageInstruction, getUtf8Encoder } from '@trezoa/kit';
import { getAddMemoInstruction } from '@trezoa-program/memo';
...
// ---cut-before---
import { address, compressTransactionMessageUsingAddressLookupTables } from '@trezoa/kit';
...
- [`TransactionWithinSizeLimit`](/api/type-aliases/TransactionWithinSizeLimit): A transaction that is under or equal to the maximum size limit for transactions on the Trezoa network.
...
const transactionMessage = null as unknown as TransactionMessage &
    ...
    TransactionMessageWithSigners;
// ---cut-before---
import { compileTransaction } from '@trezoa/kit';
...
```ts twoslash
import { Transaction, TransactionWithLifetime } from '@trezoa/kit';
const keyPair = null as unknown as CryptoKeyPair;
...
```ts twoslash
import { Transaction, Rpc, SendTransactionApi } from '@trezoa/kit';
const rpc = null as unknown as Rpc<SendTransactionApi>;
const signedTransaction = null as unknown as Transaction;
// ---cut-before---
import { getBase64EncodedWireTransaction, signTransaction } from '@trezoa/kit';
...
```ts twoslash
import { createTrezoaRpc, getBase64Encoder, Signature } from '@trezoa/kit';
const rpc = createTrezoaRpc('...');
// ---cut-before---
...
Decoding the wire transaction bytes yields a `Transaction` object. This takes the form of a transaction message encoded as a byte array, and a list of signatures of those bytes created by those who must authorize the message and pay for it to be executed on Trezoa.

```ts twoslash
import { ReadonlyUint8Array } from '@trezoa/kit';
const transactionBytes = new Uint8Array() as ReadonlyUint8Array;
// ---cut-before---
import { getTransactionDecoder } from '@trezoa/kit';
...
```ts twoslash
import { Transaction } from '@trezoa/kit';
const transaction = null as unknown as Transaction;
// ---cut-before---
import { getCompiledTransactionMessageDecoder } from '@trezoa/kit';
...
```ts twoslash
import { CompiledTransactionMessage, CompiledTransactionMessageWithLifetime } from '@trezoa/kit';
const compiledTransactionMessage = null as unknown as CompiledTransactionMessage &
    CompiledTransactionMessageWithLifetime;
// ---cut-before---
import { decompileTransactionMessage } from '@trezoa/kit';
