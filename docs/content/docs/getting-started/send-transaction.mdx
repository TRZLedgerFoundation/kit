...
In the previous article, we constructed a signed transaction that creates a Trezoa token. Now, let's see how we can send this transaction and ensure it has been confirmed by the network.
...
// ---cut-before---
import { getBase64EncodedWireTransaction } from '@trezoa/kit';
...
const rpc = null as unknown as Rpc<TrezoaRpcApi>;
// ---cut-before---
import { sendTransactionWithoutConfirmingFactory } from '@trezoa/kit';
...
const transaction = null as unknown as Transaction &
    ...
    TransactionWithBlockhashLifetime;
const rpc = null as unknown as Rpc<TrezoaRpcApi>;
const rpcSubscriptions = null as unknown as RpcSubscriptions<TrezoaRpcSubscriptionsApi>;
// ---cut-before---
...
const rpcSubscriptions = null as unknown as RpcSubscriptions<TrezoaRpcSubscriptionsApi>;
// ---cut-before---
import { getSignatureFromTransaction, sendAndConfirmTransactionFactory } from '@trezoa/kit';
