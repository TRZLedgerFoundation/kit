...
LOCK_DIR="/tmp/lock"
EXCLUSIVE_LOCK_FILE="$LOCK_DIR/.trezoatestvalidator.exclusivelock"
SHARED_LOCK_FILE="$LOCK_DIR/.trezoatestvalidator.sharedlock"
TEST_VALIDATOR=$( cd "$(dirname "${BASH_SOURCE[0]}")/.." ; pwd -P )/.trezoa/active_release/bin/trezoa-test-validator
